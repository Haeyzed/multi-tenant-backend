...
/**
 * Tenant-domain Sanctum authentication and account lifecycle operations.
 *
 * Independent from central authentication. Operates against the current tenant
 * database connection after Stancl tenancy has been initialized.
 */
final class AuthenticationService
{
    /**
     * Authenticate a tenant user and issue a Sanctum personal access token.
     *
    ...
    /**
     * Send a password reset link for a tenant user.
     *
     * Uses the `tenant_users` broker against the current tenant database.
     */
