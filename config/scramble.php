...
Platform endpoints for provisioning tenants and managing the SaaS control plane.

Authenticate with a **central** Sanctum personal access token (`Authorization: Bearer {token}`).
MD,
    ],
